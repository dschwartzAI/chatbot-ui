...
AS $$
DECLARE
  project_url TEXT := 'https://zvuoqcnqdowhdigydtoa.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp2dW9xY25xZG93aGRpZ3lkdG9hIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MjU3NDk4OSwiZXhwIjoyMDU4MTUwOTg5fQ.ZzROirSIyvEu77_FUqyb62ZmhHqhSBdacy2MnnkFEPU'; -- full access needed for http request to storage
